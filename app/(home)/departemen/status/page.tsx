...
export default async function Page() {
  ...
  const groupAngkatanByStatus = groupMhsByStatusByAngkatan(
    MhsData,
    StatusMhsData
  );
  return (
    <>
      ...
      <h1 className="text-center text-2xl font-bold font-arial">
        Rekap Mahasiswa Berdasarkan Status Informatika Fakultas Sains dan
        ...
        <thead>
          ...
          <tr>
            ...
            {groupAngkatanByStatus.map((data) => (
              <td
                key={data.angkatan}
                className="text-center border border-stone-800 py-2 px-4 bg-grey-lightest font-normal uppercase text-xl text-grey-dark"
              >
                {data.aktif}
              </td>
            ))}
