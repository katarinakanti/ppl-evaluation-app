        ...
        <div className="flex justify-end w-full">
            <div className="flex col mb-10 mr-10">
                <div className="flex w-full">
                    ...
                    <button className="w-32 h-10 bg-white hover:bg-pink-100 text-pink-400 border border-pink-400 font-semibold rounded">
                        Lihat IRS
                    </button>
                    </a>
                    {" "}
                ...
                <div className="flex w-full">
                    {/* <Link href={`/dosen/irs/${params.angkatan}/${params.nim}/${params.semester}/edit`}> */}
                    <button className="bg-white hover:bg-blue-100 text-blue-400 border border-blue-400 px-10 font-semibold rounded">
                        Ubah
                    </button>
                    {/* </Link> */}
                    {" "}
