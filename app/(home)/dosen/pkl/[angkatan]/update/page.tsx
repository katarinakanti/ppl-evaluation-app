    ...
    <>
      ...
      <div className="mx-auto bg-gray-100 w-10/12 h-fit">
            ...
            <div className="flex w-full">
              <div className="mt-16">
                ...
                <div className="flex">
                  ...
                  <p className="ml-12 text-sm flex items-center mt-5">
                    Jumlah Total SKS : 100
                  </p>
                  <p className="ml-12 text-sm flex items-center mt-5">
                    IPK : 4.00
                  </p>
                  ...
                  <div className="flex">
                    ...
                    <div className="flex ml-48">
                      ...
                      <select
                        ...
                        id="Status"
                      >
                        <option>Masukkan Status PKL</option>
        ...
        <div className="flex mt-10 justify-end mr-16">
          ...
          <button className=" ml-5 bg-green-600 hover:bg-green-400 text-white  px-7 py-1 font-semibold rounded mb-5">
            Approved
          </button>
        </div>
      </div>
