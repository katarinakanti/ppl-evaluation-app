      ...
      <div className="mx-auto bg-gray-100 w-10/12 h-fit">
        <div className="flex items-center justify-center pt-10">
          <div className="flex-col flex w-11/12">
            {MhsData.map((data) => (
              <div key={data.nim} className="flex w-full mb-8">
                ...
                <div className="flex items-center bg-gray-200 w-full h-20 p-4">
                  ...
                  <div className="ml-10 w-3/12">
                    <div className="flex items-center w-full h-10">
                      <Link
                        className="flex items-center bg-red-500 hover:bg-red-400 text-white h-full px-7"
                        href={`/dosen/khs/${data.nim}`}
                      >
                        IRS
                      </Link>
                      <Link
                        className="ml-3 flex items-center border bg-orange-500 hover:bg-orange-400 text-white h-full px-7"
                        href={`/dosen/khs/${data.nim}`}
                      >
                        KHS
                      </Link>
                      <Link
                        className="ml-3 flex items-center border bg-green-500 hover:bg-green-400 text-white h-full px-7"
                        href={`/dosen/khs/${data.nim}`}
                      >
                        PKL
                      </Link>
                      <Link
                        className="ml-3 flex items-center border bg-blue-500 hover:bg-blue-400 text-white h-full px-7"
                        href={`/dosen/khs/${data.nim}`}
                      >
                        Skripsi
                      </Link>
