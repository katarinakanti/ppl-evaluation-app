          ...
          <div className="flex items-center">
            <div className="flex-col ml-8">
              ...
              <div className="flex w-full -mt-10">
                ...
                <div className="flex items-center ml-80" > :
                      <p className="ml-10 w-80 p-2 ">9</p>
                </div>
              </div>
              ...
              <div className="flex w-full -mt-10">
                ...
                <div className="flex items-center ml-80" > :
                <p className="ml-10 w-80 p-2">31/10/2023</p>
                </div>
              </div>
                ...
                <div className="flex w-full -mt-10">
                  ...
                  <div className="flex items-center ml-80" > :
                  <p className="ml-10 w-80 p-2">Sudah Skripsi</p>
                  </div>
                </div>
      ...
                  </div>
                ...
                <button className="w-60 h-10 ml-10 bg-white hover:bg-blue-100 text-blue-400 border border-blue-400 font-semibold rounded">Lihat Berita Acara Skripsi</button>
                    {" "}
                </div>
